...
public abstract class Encryption {
    ...
    public static String MD5 (Card Tarjeta) throws NoSuchAlgorithmException{
        ...
        try {
            /*
             * Agarra todo los datos de la tarjeta, luego deeso los tranforma en bytes (8 bits de info per char)
             * Luego se usa el algoritmo MD5 para encriptar los bytes (El cual Java ya tiene LMAO)
